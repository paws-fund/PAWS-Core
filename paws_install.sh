...
COIN_REPO='https://github.com/paws-fund/paws-core.git'
COIN_TGZ='https://github.com/paws-fund/paws-core/releases/download/v1.0.0/paws-1.0.0-x86_64-linux-gnu.zip'
