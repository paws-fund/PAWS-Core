...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_CHARITY_FUND) r = SPORK_17_CHARITY_FUND_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_CHARITY_FUND") return SPORK_17_CHARITY_FUND;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_CHARITY_FUND) return "SPORK_17_CHARITY_FUND";
