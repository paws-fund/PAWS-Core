                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received PAWS from zPAWS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zPAWS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zPAWS));
