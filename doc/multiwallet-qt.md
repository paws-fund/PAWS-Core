...
In order to support loading of multiple wallets in paws-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is paws.cpp.
...
Changes to paws.cpp
----------------------
paws.cpp is the entry point into paws-qt, and as such, will require some minor modifications to provide hooks for
